...
| Главная | Личный кабинет | Публичная визитка |
|---|---|---|
| ![Главная страница CampusCard — приветственный экран с кнопкой «Создать визитку»](docs/screenshots/landing.png) | ![Личный кабинет — публичная ссылка, QR-код и переключатель публикации](docs/screenshots/dashboard.png) | ![Публичная визитка студента — шапка в цветах темы, навыки и контакты](docs/screenshots/public-card.png) |
